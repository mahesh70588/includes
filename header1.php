        ...
        <nav class="col-sm-2 bg-light sidebar py-5 d-print-none">
            ...
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                    <a  class="nav-link <?php if(PAGE =='assets'){echo 'active';} ?>" href="assets.php"><i class="fas fa-database"></i> Assets</a></li>
                    ...
                    <li class="nav-item">
                    <a  class="nav-link <?php if(PAGE =='sellreport'){echo 'active';} ?>" href="sellproductreport.php"><i class="fas fa-table"></i> Sell Report</a></li>
